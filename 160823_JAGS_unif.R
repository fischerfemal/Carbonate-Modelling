...
inits <- function () { 
  list("pCO2_Bkg" = runif(1, 300, 1000) ,"deltaA_Bkg" = runif(1, -5.5, -4.5)
       ...
       ,"MAT_Bkg_BB"= runif(1, 10, 20)
       ,"MAT_Bkg_AC"= runif(1, 10, 20)
       ,"MAT_Bkg_ES"= runif(1, 10, 20)
       ,"MAT_Bkg_CN"= runif(1, 10, 20)
...
bayes_model <- function() {
  ...
  MAT_Bkg_BB ~ dunif(5, 30)
  MAT_Bkg_AC ~ dunif(5, 30)
  MAT_Bkg_ES ~ dunif(5, 30)
  MAT_Bkg_CN ~ dunif(5, 30)
