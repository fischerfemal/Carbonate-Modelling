...
inits <- function () { 
  list("pCO2_Bkg" = runif(1, 400, 800) ,"deltaA_Bkg" = runif(1, -5.5, -4.5)
       ,"dO_MAT_sl" = runif(1, 0.2, 0.7)
       ,"pCO2_Doubling" = runif(1, 0.75, 1.25)
       ,"MAP_Bkg_BB"= runif(1, 900, 1400)
       ,"MAP_Bkg_AC"= runif(1, 300, 1100)
       ,"MAP_Bkg_ES"= runif(1, 500, 1500)
       ,"MAP_Bkg_CN"= runif(1, 500, 1500)
       ...
       ,"MAT_Bkg_BB"= runif(1, 12, 20)
       ,"MAT_Bkg_AC"= runif(1, 13, 20)
       ,"MAT_Bkg_ES"= runif(1, 14, 25)
       ,"MAT_Bkg_CN"= runif(1, 15, 25)
       ,"T_seas_Bkg_BB"= runif(1, 10, 25)
       ,"T_seas_Bkg_AC"= runif(1, 10, 25)
       ,"T_seas_Bkg_ES"= runif(1, 5, 30)
       ,"T_seas_Bkg_CN"= runif(1, 5, 30)
       ,"ST_Bkg_BB"= runif(1,0,1)
       ,"ST_Bkg_AC"= runif(1,0,1)
       ,"ST_Bkg_ES"= runif(1,0,1)
       ,"ST_Bkg_CN"= runif(1,0,1)
       ,"ch_MAT"= runif(1, 6, 8)
       ,"ch_ch_MAT_BB"= runif(1, -1, 1)
       ,"ch_ch_MAT_AC"= runif(1, -1, 1)
       ,"ch_ch_MAT_ES"= runif(1, -1, 1)
       ,"ch_ch_MAT_CN"= runif(1, -1, 1)
       ,"MAP_PETM_BB"= runif(1, 600, 1400)
       ,"MAP_PETM_AC"= runif(1, 300, 1100)
       ,"MAP_PETM_ES"= runif(1, 500, 1500)
       ,"MAP_PETM_CN"= runif(1, 500, 1500)
       ...
       ,"T_seas_PETM_BB"= runif(1, 10, 25)
       ,"T_seas_PETM_AC"= runif(1, 10, 25)
       ,"T_seas_PETM_ES"= runif(1, 5, 30)
       ,"T_seas_PETM_CN"= runif(1, 5, 30)
...
bayes_model = " model {
  ...
  pCO2_Doubling ~ dnorm(1, 25)I(0.5, 2)
  pCO2_PETM <- pCO2_Bkg * (pCO2_Doubling*2)
  deltaA_PETM <- deltaA_Bkg - 4.6
  
  pCO2_Bkg ~ dnorm(600, 0.0001)I(200, 2000)
  deltaA_Bkg ~ dnorm(-5, 16)I(-6, -4)
  dO_MAT_sl ~ dnorm(0.45, 44)I(0.2, 0.7)
  
  MAP_Bkg_BB ~ dnorm(1150, 0.000025)I(100, 2000)
  MAP_Bkg_AC ~ dnorm(450, 0.000025)I(100, 2000)
  MAP_Bkg_ES ~ dnorm(1000, 0.00000625)I(100, 2000)
  MAP_Bkg_CN ~ dnorm(1000, 0.00000625)I(100, 2000)
  
  P_seas_Bkg_BB ~ dnorm(0.15, 55)I(0, 0.4)
  P_seas_Bkg_AC ~ dnorm(0.15, 55)I(0, 0.4)
  P_seas_Bkg_ES ~ dnorm(0.15, 55)I(0, 0.4)
  P_seas_Bkg_CN ~ dnorm(0.15, 55)I(0, 0.4)
  
  MAT_Bkg_BB ~ dnorm(15, 0.25)I(5, 30)
  MAT_Bkg_AC ~ dnorm(16, 0.25)I(5, 30)
  MAT_Bkg_ES ~ dnorm(20, 0.0625)I(10, 40)
  MAT_Bkg_CN ~ dnorm(23, 0.0625)I(10, 40)
  ...
  ST_Bkg_BB ~ dnorm(0.5, 6)I(0, 1)
  ST_Bkg_AC ~ dnorm(0.5, 6)I(0, 1)
  ST_Bkg_ES ~ dnorm(0.5, 6)I(0, 1)
  ST_Bkg_CN ~ dnorm(0.5, 6)I(0, 1)
  
  ch_MAT ~ dnorm(7, 1)I(5, 9)
  ch_ch_MAT_BB ~ dnorm(0, 1)I(-2, 2)
  ch_ch_MAT_AC ~ dnorm(0, 1)I(-2, 2)
  ch_ch_MAT_ES ~ dnorm(0, 1)I(-2, 2)
  ch_ch_MAT_CN ~ dnorm(0, 1)I(-2, 2)
  
  MAP_PETM_BB ~ dnorm(1000, 0.000011)I(100, 2000)
  MAP_PETM_AC ~ dnorm(700, 0.000011)I(100, 2000)
  MAP_PETM_ES ~ dnorm(1000, 0.00000625)I(100, 2000)
  MAP_PETM_CN ~ dnorm(1000, 0.00000625)I(100, 2000)
  
  P_seas_PETM_BB ~ dnorm(0.15, 55)I(0, 0.4)
  P_seas_PETM_AC ~ dnorm(0.15, 55)I(0, 0.4)
  P_seas_PETM_ES ~ dnorm(0.15, 55)I(0, 0.4)
  P_seas_PETM_CN ~ dnorm(0.15, 55)I(0, 0.4)
  
  T_seas_PETM_BB ~ dnorm(15, 0.1)I(5, 30)
  T_seas_PETM_AC ~ dnorm(15, 0.1)I(5, 30)
  T_seas_PETM_ES ~ dnorm(10, 0.04)I(0, 20)
  T_seas_PETM_CN ~ dnorm(10, 0.04)I(0, 20)
  
  ST_PETM_BB ~ dnorm(0.5, 6)I(0, 1)
  ST_PETM_AC ~ dnorm(0.5, 6)I(0, 1)
  ST_PETM_ES ~ dnorm(0.5, 6)I(0, 1)
  ST_PETM_CN ~ dnorm(0.5, 6)I(0, 1)
...
bayes_fit <- jags(model.file = textConnection(bayes_model), parameters.to.save = parameters, data = carbonate_data, inits = NULL, 
                  n.chains=3, n.iter = 10000000, n.burnin = 5000000, n.thin = 100
)

# update if there is little convergence

bayes_fit_upd <- autojags(bayes_fit, n.iter=5000000, n.thin=1000, n.update = 5)
...
pdf("160908_jags_upd_plots.pdf")

denplot(bayes_fit_mcmc_upd, "MAP_Bkg_BB")
denplot(bayes_fit_mcmc_upd, "MAP_PETM_BB")
denplot(bayes_fit_mcmc_upd, "MAP_Bkg_AC")
denplot(bayes_fit_mcmc_upd, "MAP_PETM_AC")
denplot(bayes_fit_mcmc_upd, "MAP_Bkg_ES")
denplot(bayes_fit_mcmc_upd, "MAP_PETM_ES")
denplot(bayes_fit_mcmc_upd, "MAP_Bkg_CN")
denplot(bayes_fit_mcmc_upd, "MAP_PETM_CN")
denplot(bayes_fit_mcmc_upd, "P_seas_Bkg_BB")
denplot(bayes_fit_mcmc_upd, "P_seas_PETM_BB")
denplot(bayes_fit_mcmc_upd, "P_seas_Bkg_AC")
denplot(bayes_fit_mcmc_upd, "P_seas_PETM_AC")
denplot(bayes_fit_mcmc_upd, "P_seas_Bkg_ES")
denplot(bayes_fit_mcmc_upd, "P_seas_PETM_ES")
denplot(bayes_fit_mcmc_upd, "P_seas_Bkg_CN")
denplot(bayes_fit_mcmc_upd, "P_seas_PETM_CN")
denplot(bayes_fit_mcmc_upd, "MAT_Bkg_BB")
denplot(bayes_fit_mcmc_upd, "MAT_Bkg_AC")
denplot(bayes_fit_mcmc_upd, "MAT_Bkg_ES")
denplot(bayes_fit_mcmc_upd, "MAT_Bkg_CN")
denplot(bayes_fit_mcmc_upd, "T_seas_Bkg_BB")
denplot(bayes_fit_mcmc_upd, "T_seas_PETM_BB")
denplot(bayes_fit_mcmc_upd, "T_seas_Bkg_AC")
denplot(bayes_fit_mcmc_upd, "T_seas_PETM_AC")
denplot(bayes_fit_mcmc_upd, "T_seas_Bkg_ES")
denplot(bayes_fit_mcmc_upd, "T_seas_PETM_ES")
denplot(bayes_fit_mcmc_upd, "T_seas_Bkg_CN")
denplot(bayes_fit_mcmc_upd, "T_seas_PETM_CN")
denplot(bayes_fit_mcmc_upd, "ch_MAT")
denplot(bayes_fit_mcmc_upd, "ch_ch_MAT_BB")
denplot(bayes_fit_mcmc_upd, "ch_ch_MAT_AC")
denplot(bayes_fit_mcmc_upd, "ch_ch_MAT_ES")
denplot(bayes_fit_mcmc_upd, "ch_ch_MAT_CN")
denplot(bayes_fit_mcmc_upd, "deltaA_Bkg")
denplot(bayes_fit_mcmc_upd, "pCO2_Doubling")
denplot(bayes_fit_mcmc_upd, "pCO2_Bkg")
denplot(bayes_fit_mcmc_upd, "dO_MAT_sl")
denplot(bayes_fit_mcmc_upd, "ST_Bkg_BB")
denplot(bayes_fit_mcmc_upd, "ST_PETM_BB")
denplot(bayes_fit_mcmc_upd, "ST_Bkg_AC")
denplot(bayes_fit_mcmc_upd, "ST_PETM_AC")
denplot(bayes_fit_mcmc_upd, "ST_Bkg_ES")
denplot(bayes_fit_mcmc_upd, "ST_PETM_ES")
denplot(bayes_fit_mcmc_upd, "ST_Bkg_CN")
denplot(bayes_fit_mcmc_upd, "ST_PETM_CN")

dev.off()



pdf("160907_jags_plots.pdf")

denplot(bayes_fit_mcmc, "MAP_Bkg_BB")
denplot(bayes_fit_mcmc, "MAP_PETM_BB")
denplot(bayes_fit_mcmc, "MAP_Bkg_AC")
denplot(bayes_fit_mcmc, "MAP_PETM_AC")
denplot(bayes_fit_mcmc, "MAP_Bkg_ES")
denplot(bayes_fit_mcmc, "MAP_PETM_ES")
denplot(bayes_fit_mcmc, "MAP_Bkg_CN")
denplot(bayes_fit_mcmc, "MAP_PETM_CN")
denplot(bayes_fit_mcmc, "P_seas_Bkg_BB")
denplot(bayes_fit_mcmc, "P_seas_PETM_BB")
denplot(bayes_fit_mcmc, "P_seas_Bkg_AC")
denplot(bayes_fit_mcmc, "P_seas_PETM_AC")
denplot(bayes_fit_mcmc, "P_seas_Bkg_ES")
denplot(bayes_fit_mcmc, "P_seas_PETM_ES")
denplot(bayes_fit_mcmc, "P_seas_Bkg_CN")
denplot(bayes_fit_mcmc, "P_seas_PETM_CN")
denplot(bayes_fit_mcmc, "MAT_Bkg_BB")
denplot(bayes_fit_mcmc, "MAT_Bkg_AC")
denplot(bayes_fit_mcmc, "MAT_Bkg_ES")
denplot(bayes_fit_mcmc, "MAT_Bkg_CN")
denplot(bayes_fit_mcmc, "T_seas_Bkg_BB")
denplot(bayes_fit_mcmc, "T_seas_PETM_BB")
denplot(bayes_fit_mcmc, "T_seas_Bkg_AC")
denplot(bayes_fit_mcmc, "T_seas_PETM_AC")
denplot(bayes_fit_mcmc, "T_seas_Bkg_ES")
denplot(bayes_fit_mcmc, "T_seas_PETM_ES")
denplot(bayes_fit_mcmc, "T_seas_Bkg_CN")
denplot(bayes_fit_mcmc, "T_seas_PETM_CN")
denplot(bayes_fit_mcmc, "ch_MAT")
denplot(bayes_fit_mcmc, "ch_ch_MAT_BB")
denplot(bayes_fit_mcmc, "ch_ch_MAT_AC")
denplot(bayes_fit_mcmc, "ch_ch_MAT_ES")
denplot(bayes_fit_mcmc, "ch_ch_MAT_CN")
denplot(bayes_fit_mcmc, "pCO2_Doubling")
denplot(bayes_fit_mcmc, "pCO2_Bkg")
denplot(bayes_fit_mcmc, "pCO2_PETM")
denplot(bayes_fit_mcmc, "dO_MAT_sl")
denplot(bayes_fit_mcmc, "ST_Bkg_BB")
denplot(bayes_fit_mcmc, "ST_PETM_BB")
denplot(bayes_fit_mcmc, "ST_Bkg_AC")
denplot(bayes_fit_mcmc, "ST_PETM_AC")
denplot(bayes_fit_mcmc, "ST_Bkg_ES")
denplot(bayes_fit_mcmc, "ST_PETM_ES")
denplot(bayes_fit_mcmc, "ST_Bkg_CN")
denplot(bayes_fit_mcmc, "ST_PETM_CN")
